...
\centering
\includegraphics<1>[width=0.75\textwidth]{QUIJOTE_Dataset_2_raster}%
\includegraphics<2->[width=0.75\textwidth]{QUIJOTE-Sim_raster}%
%\includegraphics<1>[width=0.75\textwidth]{QUIJOTE_Dataset_2_raster}%
%\includegraphics<2->[width=0.75\textwidth]{QUIJOTE-Sim_raster}%
%
%\only<3->{%
...
\begin{columns}
        ...
        \includegraphics[width=1\textwidth]{QUIJOTE-Sim_calibrated_raster}
